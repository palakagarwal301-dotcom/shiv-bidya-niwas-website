...
const IEPFChecker = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validation
    if (!formData.pan_number || !formData.full_name || !formData.email || !formData.phone) {
      ...
      <div className="pt-32 pb-12 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Enter your details below and we'll check if you have any unclaimed shares or dividends transferred to IEPF.
          </p>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="If you know the company name"
                  className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all"
                />
              </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-blue-800">
                  <strong>Note:</strong> We'll check your details against IEPF MCA database and email you the results within 24 hours. This service is completely free.
                </p>
              </div>
